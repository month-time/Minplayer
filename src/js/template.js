...
//************************************************************************************************
        ...
        this.browserFullButton = this.container.querySelector('.dplayer-full-in-icon');
        this.webFullButton = this.container.querySelector('.dplayer-full-in-two-icon');
        this.wideScreenButton = this.container.querySelector('.dplayer-full-icon');
        ...
        <div class="dplayer-controller">
            ...
            <div class="dplayer-icons dplayer-icons-right">
                ...
                <div class="dplayer-full">
					<button class="dplayer-icon dplayer-full-in-two-icon" data-balloon="${tran('Web full screen')}" data-balloon-pos="left">
                        <span class="dplayer-icon-content">${icons.get('full-in')}</span>
                    </button>
                    <button class="dplayer-icon dplayer-full-in-icon" data-balloon="${tran('Full screen')}" data-balloon-pos="left">
                        <span class="dplayer-icon-content">${icons.get('full')}</span>
                    </button>
                    <button class="dplayer-icon dplayer-full-icon" data-balloon="${tran('Wide screen')}" data-balloon-pos="up">
                        <span class="dplayer-icon-content">${icons.get('widescreen')}</span>
                    </button>
                </div>
            </div>
            ...
            <div class="dplayer-icons dplayer-comment-box">
                ...
                <div class="dplayer-comment-setting-box">
                    <div class="dplayer-comment-setting-color">
                        ...
                        <label>
                            <input type="radio" name="dplayer-danmaku-color-${index}" value="#FFFFFF" checked>
